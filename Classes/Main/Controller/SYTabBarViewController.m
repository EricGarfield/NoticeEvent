...
-(void)detailsOfViewDidLoad {
    ...
    [self addChildVc:counterView navTitle:@"ondine" tabbarTitle:@"Time" image:@"tabbar_counter" selectedImage:@"tabbar_counter_selected"];
    ...
    [self addChildVc:percentageGraphView navTitle:@"ondine" tabbarTitle:@"Statistics" image:@"tabbar_percentage_graph" selectedImage:@"tabbar_percentage_graph_selected"];
}
